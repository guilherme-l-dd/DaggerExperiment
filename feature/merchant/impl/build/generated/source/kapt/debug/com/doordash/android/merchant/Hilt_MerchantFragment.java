...
public abstract class Hilt_MerchantFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MerchantFragment() {
    super();
  }

  Hilt_MerchantFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MerchantFragment_GeneratedInjector) this.generatedComponent()).injectMerchantFragment(UnsafeCasts.<MerchantFragment>unsafeCast(this));
    }
  }
